...
spam_filter = {
    ...
    'text': [
        '.ру', 'nуmрhоmaniа', 'нимфoманией', 'биceкcyальнa', 'любoвью', '<',
        'url', 'http:', 'порно', 'кролика', 'используете базы', 'bit.ly', 'Некая Алиса', 'Букмекеры',
        '.buzz', 'SEO продвижение', 'базы ВЭД', 'продвижением сайтов', 'Подберем новых', 'Domain Rating', 'база',
        ...
        'advertising', 'Рассылаем', 'Я частный специалист', 'много недоработок по SEO', 'свежий дизайн',
        'Предлагаем рассылку', 'Юридический адрес в Новосибирске', 'Заинтересовал ваш продукт, можете перезвонить', 'Благотворительный фонд', 
        'по вашим товарам и доставке', 'casino', 'Бесплатно продвинем', 'traffic', 'продвижение сайтов', 'продаж', 'Get Real Traffic',
        ...
        'кредит', '1E5TMy21DM2cR13sQbLukgKBkR3ZSaRbeB', 'RbeB', 'script', 'jackpot', 'following', 'script', 'профиль', 'developer', 'centuries', 'social', 'smoke'
    ]
}