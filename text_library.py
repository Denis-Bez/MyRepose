...
spam_filter = {
    ...
    'text': [
        '.ру', 'nуmрhоmaniа', 'нимфoманией', 'биceкcyальнa', 'любoвью', '<a',
        'url', 'ttp:', 'порно', 'кролика', 'используете базы', 'bit.ly', 'Некая Алиса', 'Букмекеры',
        ...
        'домофон', '2ГИС', 'Яндекс карт', 'база компаний', 'такси', 'registering', 'DOCTYPE', 'html', 'HTML', 'Продвижение сайта'
    ]
}